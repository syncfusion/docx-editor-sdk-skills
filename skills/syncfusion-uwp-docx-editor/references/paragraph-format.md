# Paragraph Formatting in UWP DOCX Editor

Paragraph formatting support in the Syncfusion UWP DOCX Editor allows controlling paragraph layout and text flow within documents.
...
```csharp
richTextBoxAdv.IncreaseIndentCommand.Execute("24");

richTextBoxAdv.DecreaseIndentCommand.Execute("24");
```
