# Styles in UWP DOCX Editor

Styles support in the Syncfusion UWP DOCX Editor allows creating and managing reusable formatting styles within documents.
...
newCharStyle.CharacterFormat.FontColor = Color.FromArgb(255, 47, 84, 150);
...
- ` Color.FromArgb(255, 47, 84, 150)` → Replace with `{fontColor}`
...
newParaStyle.CharacterFormat.FontColor = Color.FromArgb(255,47, 84, 150);
...
linkedParaStyle.CharacterFormat.FontColor = Color.FromArgb(255,47, 84, 150);
