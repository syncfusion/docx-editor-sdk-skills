# Section Formatting in UWP DOCX Editor

Section formatting support in the Syncfusion UWP DOCX Editor allows controlling page‑level layout and header/footer behavior within documents.
