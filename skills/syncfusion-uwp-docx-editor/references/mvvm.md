# MVVM Support in UWP DOCX Editor

MVVM support in the Syncfusion UWP DOCX Editor enables integrating `SfRichTextBoxAdv` into Model‑View‑ViewModel architectures using data binding.

---

## Creating a View Model

- This example demonstrates implementing a view model that stores animal descriptions and keeps the selected animal’s description synchronized when the selection changes.
