# MVVM Support in WPF DOCX Editor

MVVM support in the Syncfusion WPF DOCX Editor enables integrating `SfRichTextBoxAdv` into
Model‑View‑ViewModel architectures using data binding.
