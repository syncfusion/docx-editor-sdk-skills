# Templates and Styling in WPF DOCX Editor

Template and styling support in the Syncfusion WPF DOCX Editor allows customizing the appearance and visual structure of the editor control using WPF styles and templates.
...
- `RichTextBoxAdvCustomStyle` → Replace with `{customStyleKey}`