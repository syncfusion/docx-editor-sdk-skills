# Saving Documents in WPF DOCX Editor

Document saving support in the Syncfusion WPF DOCX Editor allows exporting document content to files and streams using built‑in APIs and commands.
...
<Button Content="Open" Command="RichTextBoxAdv:SfRichTextBoxAdv.SaveDocumentCommand" CommandTarget="{Binding ElementName=richTextBoxAdv}" />
