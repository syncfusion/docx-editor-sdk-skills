...
Selection support in the Syncfusion WPF DOCX Editor allows selecting, navigating, and manipulating document content within the editor.
...
**Placeholders**
- `Syncfusion.Windows.Controls.RichTextBoxAdv.BaselineAlignment.Subscript` → Replace with `{baselineAlignment}`
...
SfRichTextBoxAdv.SelectAllCommand.Execute(null, richTextBoxAdv);
 ```
---
