...
```typescript
// Set local paste off so server-side conversion is used
<ejs-documenteditor [enableLocalPaste]="false" serviceUrl="{backendServiceUrl}" height="600px"></ejs-documenteditor>
```
