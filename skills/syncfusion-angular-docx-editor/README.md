# Syncfusion<sup>®</sup> Angular DOCX Editor Skill

## Overview

Build MS Word–like document editor applications in Angular using the Syncfusion DOCX Editor. This skill provides AI-guided code generation and integration support for the Angular document editor component, enabling editing, formatting, import/export capabilities, and more.
...
Clone or download the DOCX-Editor-SDK-Skills repository and copy the **syncfusion-angular-docx-editor** skill from the `skills/` directory.
...
1. **Slash commands** - Type `/` in the GitHub Copilot chat to see available skills. For example:
   ```
   /syncfusion-angular-docx-editor Create a Document Editor with built-in toolbar options
   ```

2. **Automatic loading** - Simply describe your task naturally, and your AI Agent automatically loads the relevant skill:
   ```
   Create an Angular document editor with a built-in toolbar that allows users to open, edit, and save documents
   ```
...
To integrate the Syncfusion DOCX Editor component directly into your project files, you need a working Angular application. If you don't have one yet, follow the [Getting Started guide](https://help.syncfusion.com/document-processing/word/word-processor/angular/getting-started) to set up a new Angular project with Angular CLI.

**Alternative Options:**
- **No project needed:** You can request code snippets directly in the chat window for learning or reference purposes
- **Separate file generation:** Code can be saved to the skill's output folder (`syncfusion-angular-docx-editor/output/`) as standalone files
...
| **Document loading issue** |  The document fails to load due to an unreachable or incorrect service URL. See [Link](https://help.syncfusion.com/document-processing/word/word-processor/angular/troubleshooting/document-loading-issue-with-404-error)|

---

## Resources

- [Documentation](https://help.syncfusion.com/document-processing/word/word-processor/angular/overview)
- [API Reference](https://ej2.syncfusion.com/angular/documentation/api/document-editor-container/index-default)
- [Online Demo](https://document.syncfusion.com/demos/docx-editor/angular/#/tailwind3/document-editor/default)

---

## License

Syncfusion Angular DOCX Editor SDK require a [commercial license](https://www.syncfusion.com/docx-editor-sdk/angular-docx-editor) for production use. A [free Community License](https://www.syncfusion.com/products/communitylicense) is also available for individual developers and small businesses.
